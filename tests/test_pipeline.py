...
@pytest.mark.parametrize('file_path, patterns, subject, expected',
                         [
                             (a_study_in_scarlet_path, a_study_in_scarlet, 'investigator', "The investigator's appearance for the 1st time is in chapter #1 and sentence #41. The investigator is Sherlock Holmes. The most common words surrounding \"Sherlock Holmes\" are: remarked (3 times), asked (3 times), sprang (3 times)."),
                             (a_study_in_scarlet_path, a_study_in_scarlet, 'perpetrator', "The perpetrator's appearance for the 1st time is in chapter #7 and sentence #186. The perpetrator is Jefferson Hope. The most common words surrounding \"Jefferson Hope\" are: among (3 times), led (3 times), able (2 times)."),
